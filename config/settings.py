...
if (
    ...
    and (IS_VERCEL or USE_TURSO)
    and TURSO_CONFIGURATION_IS_PLACEHOLDER
):
    raise ImproperlyConfigured(
        "Configurez DATABASE_URL/POSTGRES_URL pour Neon, ou "
        "TURSO_DATABASE_URL et TURSO_AUTH_TOKEN pour Turso."
    )
...
elif (IS_VERCEL or USE_TURSO) and TURSO_DATABASE_URL:
    # ==================================================
    # PRODUCTION : TURSO
    # ==================================================
    DATABASES = {
